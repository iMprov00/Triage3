...
export default function PatientFormPage() {
  ...
  async function submit(e: React.FormEvent) {
    ...
    try {
      await apiJson(`/api/v1/stage2/patients/${patientId}`, { method: "PATCH", json: body });
      nav("/patients");
    } catch (ex: unknown) {
      const e = ex as { body?: { errors?: string[]; error?: string } };
      setErr(e.body?.errors?.join(", ") || e.body?.error || "Ошибка сохранения");
    }
  }
        ...
        <div className="card-body">
          ...
          <div className="row g-2">
            <div className="col-md-6">
              <label className="form-label">Дата поступления (этап 2)</label>
