...
export default function Stage2PhaseEditConfirmDialog({
  open,
  title,
  children,
  ...
  return (
    <>
      ...
      <div className="modal fade show d-block" role="dialog" aria-modal="true" aria-labelledby="stage2-edit-confirm-title">
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-header">
              <h2 className="modal-title h5" id="stage2-edit-confirm-title">
                {title}
              </h2>
